...
import fotoSobreMim from "assets/jhonP.jpg";
...
export default function SobreMim() {
    return (
        ...
        >
            ...
            <p className={styles.paragrafo}>
                Minha história com programação começou na plataforma da alura, quando fiz o ensino médio integrado ao curso de Informática. Eu aprendi lógica de programação e o básico de várias linguagens, como PHP, Python, Java, mas sem aprofundar muito em cada uma delas. Eu gostava muito de estudar programação, mas na época não fazia ideia de que trabalharia com isso hoje.
            </p>
            <p className={styles.paragrafo}>
